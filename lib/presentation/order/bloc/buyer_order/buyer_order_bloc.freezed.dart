...
mixin _$BuyerOrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<BuyerOrder> orders) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<BuyerOrder> orders)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<BuyerOrder> orders});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<BuyerOrder> orders) : _orders = orders;

  final List<BuyerOrder> _orders;
  @override
  List<BuyerOrder> get orders {
  ...
  @override
  String toString() {
    return 'BuyerOrderState.loaded(orders: $orders)';
  }
...
abstract class _Loaded implements BuyerOrderState {
  const factory _Loaded(final List<BuyerOrder> orders) = _$LoadedImpl;
